...
class Uygulama:
    def __init__(self):
        ...
        self.images = [
            r"C:\Users\zeyne\OneDrive\Masaüstü\Yeni klasör (2)\images2.png",
            r"C:\Users\zeyne\OneDrive\Masaüstü\Yeni klasör (2)\images3.png",
            r"C:\Users\zeyne\OneDrive\Masaüstü\Yeni klasör (2)\images4.png",
            r"C:\Users\zeyne\OneDrive\Masaüstü\Yeni klasör (2)\images5.png",
            r"C:\Users\zeyne\OneDrive\Masaüstü\Yeni klasör (2)\images6.png"
        ]
    ...
    def chat(self):
        subprocess.Popen(["python", "Assigment-3.py"])
